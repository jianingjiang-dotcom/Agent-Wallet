...
const iconData: string[][] = [
  ...
  // Pact (shield — contract/protection/agreement)
  [
...
const navPaths = ['/home', '/assistant', '/pact', '/history', '/mine'];
...
export function BottomNav({ activeOverride }: { activeOverride?: number } = {}) {
  ...
  const t = useT();
  const tabLabels = [t.nav.wallet, t.nav.assistant, t.nav.pact, t.nav.transactions, t.nav.mine];
